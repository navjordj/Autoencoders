...
class ConvAutoencoder():
    ...
    def __init__(self, input_shape, filter_sizes, kernel_size, strides=1, pool_shape=(2, 2), activation="relu"):
    ...
    def _create_model(self):
        ...
        decoded = encoded
        for filter_size in reversed(self.filter_sizes):
...
if __name__ == "__main__":
    model = ConvAutoencoder(input_shape=(28, 28, 1), filter_sizes=[16, 8, 8], kernel_size=(2, 2))
